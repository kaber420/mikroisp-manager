...
class MikrotikInterfaceManager:
    ...
    def get_wireless_interfaces(self) -> tuple[list[dict[str, Any]], str | None]:
        """
    ...
    def get_wireless_interface_path(self, wireless_type: str | None) -> str | None:
        """
    ...
    def get_registration_table_path(self, wireless_type: str | None) -> str | None:
        """
    ...
    def add_vlan(self, name: str, vlan_id: str, interface: str, comment: str) -> dict[str, Any]:
        ...
        vlan_resource.add(name=name, vlan_id=vlan_id, interface=interface, comment=comment)
    ...
    def update_vlan(
        ...
        vlan_resource = self.api.get_resource("/interface/vlan")
        vlan_resource.set(id=vlan_id, name=name, vlan_id=new_vlan_id, interface=interface)
                ...
                if is_running:
                    try:
                        monitor_result = ethernet_resource.call(
                            "monitor", {"numbers": iface_name, "once": ""}
                        )
