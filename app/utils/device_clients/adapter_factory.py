    ...
    **kwargs,
    ...
    if vendor_normalized == DeviceVendor.UBIQUITI:
        ...
        return UbiquitiAirmaxAdapter(
            host=host, username=username, password=password, port=port, use_https=use_https
        )
        ...
        raise ValueError(
            f"Unsupported vendor: {vendor}. Supported: {DeviceVendor.UBIQUITI}, {DeviceVendor.MIKROTIK}"
        )
