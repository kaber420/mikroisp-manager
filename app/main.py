...
async def serve_frontend(full_path: str, request: Request):
    ...
    # Primero buscamos en la ruta de OmniWISP PRO
    legacy_frontend_dir = os.path.join(current_dir, "..", "omniwisp-0.0.1", "build")
    # Luego producción (build en la raíz)
    ...
    elif os.path.isdir(prod_frontend_dir):
        frontend_dir = prod_frontend_dir
    else:
        frontend_dir = dev_frontend_dir
