...
def _ensure_env():
    ...
    if not os.path.exists(ENV_FILE):
        print(f"⚠️  {ENV_FILE} not found. Generating default configuration...")
        try:
        ...
        if updates:
            print(f"⚠️  Updating {ENV_FILE} with missing keys...")
...
def main():
    ...
    parser.add_argument("--run-frontend", action="store_true", help="Iniciar también el frontend de desarrollo SvelteKit V2")
