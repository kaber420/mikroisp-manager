<script lang="ts">
	...
	onMount(() => {
		// Inicializa la sesión y conecta WebSocket (solo para rutas en este grupo)
...
>
	<!-- ===== TOP NAVBAR ===== -->
	<header class="navbar bg-base-100 shadow-md sticky top-0 z-50 px-4">
	...
	<main class="flex-1 container mx-auto max-w-full px-4 py-6 overflow-y-auto">
		{@render children()}
	</main>
